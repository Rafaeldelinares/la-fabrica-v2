...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'crm',
      testMatch: ['e2e/s01-stale-phase-label-cleanup.spec.js', 'e2e/s02-admin-error-boundaries.spec.js', 'e2e/s03-dev-eventos-shim.spec.js', 'e2e/s04-operator-live-kpis.spec.js', 'e2e/s06-react-query-operator-data.spec.js'],
      use: {
