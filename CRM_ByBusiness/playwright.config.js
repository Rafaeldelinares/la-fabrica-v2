...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'crm',
      testMatch: ['e2e/s01-stale-phase-label-cleanup.spec.js', 'e2e/s02-admin-error-boundaries.spec.js', 'e2e/s03-dev-eventos-shim.spec.js', 'e2e/s04-operator-live-kpis.spec.js', 'e2e/s05-lead-callbacks.spec.js', 'e2e/s06-react-query-operator-data.spec.js', 'e2e/s07-lead-freeze-list.spec.js', 'e2e/s08-admin-audit-trail.spec.js', 'e2e/s09-backup-operations.spec.js', 'e2e/s10-rbac-coverage.spec.js', 'e2e/s11-scraper-health-panel.spec.js', 'e2e/s12-reputation-feed.spec.js', 'e2e/s13-lead-freshness-config.spec.js', 'e2e/s14-scraper-config-panel.spec.js', 'e2e/f01-sidebar-routing.spec.js', 'e2e/f02-watchdog-skip-coverage.spec.js'],
      use: {
